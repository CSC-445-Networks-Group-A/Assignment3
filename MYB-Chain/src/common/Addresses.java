...
public class Addresses {
    public static final String USER_REQUEST_ADDRESS;
    public static final String USER_RECEIVE_UPDATE_ADDRESS;
    public static final String MINER_PROPOSAL_ADDRESS;
